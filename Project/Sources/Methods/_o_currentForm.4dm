...
If (This:C1470[""]=Null:C1517)  // Constructor
	...
	$o:=New object:C1471(\
		...
		"call"; Formula:C1597(_o_currentForm("call"; Choose:C955(Value type:C1509($1)=Is object:K8:27; $1; New object:C1471("parameters"; $1)))); \
		"get"; Formula:C1597(_o_currentForm); \
		"getEvent"; Formula:C1597(_o_currentForm("getEvent")); \
		"getCurrentWidget"; Formula:C1597(_o_currentForm("getCurrentWidget")); \
		"getEnterableWidgets"; Formula:C1597(_o_currentForm("getEnterableWidgets")); \
		"getFocusedWidget"; Formula:C1597(_o_currentForm("getFocusedWidget"))\
		)
