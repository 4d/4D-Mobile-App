...
ASSERT:C1129(JSON Stringify:C1217(ob_deepMerge(New object:C1471("a"; "avalue"); New object:C1471("b"; "bvalue")))=JSON Stringify:C1217(New object:C1471("a"; "avalue"; "b"; "bvalue")))
ASSERT:C1129(JSON Stringify:C1217(ob_deepMerge(New object:C1471("a"; "avalue"); New object:C1471("a"; "bvalue")))=JSON Stringify:C1217(New object:C1471("a"; "bvalue")))
ASSERT:C1129(JSON Stringify:C1217(ob_deepMerge(New object:C1471("a"; "avalue"); New object:C1471("a"; "bvalue"); True:C214))=JSON Stringify:C1217(New object:C1471("a"; "bvalue")))

ASSERT:C1129(JSON Stringify:C1217(ob_deepMerge(New object:C1471("a"; "avalue"); New object:C1471("a"; "bvalue"); False:C215))=JSON Stringify:C1217(New object:C1471("a"; "avalue")))
