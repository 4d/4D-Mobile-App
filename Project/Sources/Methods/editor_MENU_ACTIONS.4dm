...
Case of 
	...
	: ($Mnu_choice="xCode")
		...
		If ($Obj_result.success)
			...
			If (String:C10(commonValues.xCode.fileFocus)#"")
				...
				$Obj_result:=Xcode (New object:C1471(\
					"action";"reveal";\
					"path";$Path_product.platformPath+Convert path POSIX to system:C1107(commonValues.xCode.fileFocus)))
	...
	: ($Mnu_choice="_openTemplateFolder")
		...
		SHOW ON DISK:C922(_o_Pathname ("templates"))
