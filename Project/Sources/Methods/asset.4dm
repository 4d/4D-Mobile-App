										...
										If (OK=1)
											...
											For each ($Obj_image; $Obj_.images)
												...
												Else 
													...
													$Obj_out.errors.push("Failed to create thumbnail for "+String:C10($sourceFile.platformPath)+" with size "+JSON Stringify:C1217($Obj_in.size)+" and scale "+String:C10($Lon_scale))
