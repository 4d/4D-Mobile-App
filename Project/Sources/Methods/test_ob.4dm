...
$c:=New collection:C1472(New object:C1471("a"; New object:C1471("b"; 1); "test"; \
New collection:C1472(1; 2; New object:C1471("b"; 1); 4; 5)))
...
ASSERT:C1129($ob.getByPath("a.z")=Null:C1517)
ASSERT:C1129($ob.getByPath("test[2].z")=Null:C1517)

// === === === === === === === === === === === === === === === === === === === === clone()
$ob.set(New object:C1471)
$o:=New object:C1471(\
"uuid"; "hello world"; \
"level"; New collection:C1472(New object:C1471("uuid"; Generate UUID:C1066)))
$ob.clone($o)
ASSERT:C1129(JSON Stringify:C1217($ob.contents)=JSON Stringify:C1217($o))

// === === === === === === === === === === === === === === === === === === === assign()
$ob.set(New object:C1471)
$ob.assign(New object:C1471(\
"a"; 1))
...
$ob.set(New object:C1471(\
"test"; "test"; \
"level"; New object:C1471("uuid"; Generate UUID:C1066)))
$o:=$ob.findPropertyValues("uuid")
...
// === === === === === === === === === === === === === === === === === === === === coalescence()
$o:=New object:C1471(\
"a"; Null:C1517; "b"; New object:C1471(); \
"c"; Null:C1517; "d"; New collection:C1472(); \
"e"; Null:C1517; "f"; True:C214; \
"g"; Null:C1517; "h"; Pi:K30:1; \
"i"; Null:C1517; "j"; "hello world")
$ob.set($o).coalescence()
ASSERT:C1129($ob.count()=5)
ASSERT:C1129($ob.contents.b#Null:C1517)
ASSERT:C1129($ob.contents.d#Null:C1517)
ASSERT:C1129($ob.contents.f#Null:C1517)
ASSERT:C1129($ob.contents.h#Null:C1517)
ASSERT:C1129($ob.contents.j#Null:C1517)
