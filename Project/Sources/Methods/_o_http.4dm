...
If (This:C1470[""]=Null:C1517)  // Constructor
	...
	$o:=New object:C1471(\
		...
		"get"; Formula:C1597(_o_http("get"; New object:C1471("type"; $1; "keep-alive"; Bool:C1537($2); "more"; $3))); \
		"url"; Formula:C1597(_o_http("url"; New object:C1471("url"; $1))); \
		"errorCodeMessage"; Formula:C1597(_o_http("errorCodeMessage"; New object:C1471("code"; Num:C11($1))).message); \
		"myIP"; Formula:C1597(_o_http("myIP").ip); \
		"statusCodeMessage"; Formula:C1597(_o_http("statusCodeMessage"; New object:C1471("code"; Num:C11($1))).message); \
		"type"; Formula:C1597(_o_http("type"; New object:C1471("type"; $1)))\
		)
