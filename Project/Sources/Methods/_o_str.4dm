...
If (This:C1470[""]=Null:C1517)
	...
	$o:=New object:C1471(\
		...
		"length"; Length:C16($t); \
		"value"; $t; \
		"base64"; Formula:C1597(_o_str("base64").value); \
		"common"; Formula:C1597(_o_str("common"; New object:C1471("with"; $1; "diacritical"; Bool:C1537($2))).value); \
		"concat"; Formula:C1597(_o_str("concat"; New object:C1471("item"; $1; "separator"; $2)).value); \
		"contains"; Formula:C1597(_o_str("contains"; New object:C1471("pattern"; String:C10($1); "diacritical"; Bool:C1537($2))).value); \
		"distinctLetters"; Formula:C1597(_o_str("distinctLetters"; New object:C1471("delimiter"; $1)).value); \
		"equal"; Formula:C1597(_o_str("equal"; New object:C1471("with"; $1)).value); \
		"fixedLength"; Formula:C1597(_o_str("fixedLength"; New object:C1471("length"; $1; "filler"; $2; "alignment"; $3)).value); \
		"hyphenation"; Formula:C1597(This:C1470.wordWrap($1)); \
		"insert"; Formula:C1597(_o_str("insert"; New object:C1471("value"; String:C10($1); "begin"; Num:C11($2); "end"; Num:C11($3)))); \
		"isAscii"; Formula:C1597(_o_str("isAscii").value); \
		"isBoolean"; Formula:C1597(_o_str("isBoolean").value); \
		"isDate"; Formula:C1597(_o_str("isDate").value); \
		...
		"isNum"; Formula:C1597(_o_str("isNum").value); \
		"isStyled"; Formula:C1597(_o_str("isStyled").value); \
		"isTime"; Formula:C1597(_o_str("isTime").value); \
		"isUrl"; Formula:C1597(_o_str("isUrl").value); \
		"localized"; Formula:C1597(_o_str("localized"; New object:C1471("substitution"; $1)).value); \
		"lowerCamelCase"; Formula:C1597(_o_str("lowerCamelCase").value); \
		"match"; Formula:C1597(_o_str("match"; New object:C1471("pattern"; $1)).value); \
		...
		"replace"; Formula:C1597(_o_str("replace"; New object:C1471("old"; $1; "new"; $2)).value); \
		"setText"; Formula:C1597(_o_str("setText"; New object:C1471("value"; String:C10($1)))); \
		"shuffle"; Formula:C1597(_o_str("shuffle"; New object:C1471("length"; $1)).value); \
		"singleQuoted"; Formula:C1597("'"+String:C10(This:C1470.value)+"'"); \
		"spaceSeparated"; Formula:C1597(_o_str("spaceSeparated").value); \
		"toNum"; Formula:C1597(_o_str("filter"; New object:C1471("as"; "numeric")).value); \
		"trim"; Formula:C1597(_o_str("trim"; New object:C1471("pattern"; $1)).value); \
		"trimLeading"; Formula:C1597(_o_str("trimLeading"; New object:C1471("pattern"; $1)).value); \
		"trimTrailing"; Formula:C1597(_o_str("trimTrailing"; New object:C1471("pattern"; $1)).value); \
		"truncate"; Formula:C1597(_o_str("truncate"; New object:C1471("maxChar"; $1)).value); \
		"unaccented"; Formula:C1597(_o_str("unaccented").value); \
		"uperCamelCase"; Formula:C1597(_o_str("uperCamelCase").value); \
		"urlBase64Encode"; Formula:C1597(_o_str("urlBase64Encode").value); \
		"urlDecode"; Formula:C1597(_o_str("urlDecode").value); \
		"urlEncode"; Formula:C1597(_o_str("urlEncode").value); \
		"wordWrap"; Formula:C1597(_o_str("wordWrap"; New object:C1471("length"; $1)).value); \
		"xmlEncode"; Formula:C1597(_o_str("xmlEncode").value); \
		"versionCompare"; Formula:C1597(_o_str("versionCompare"; New object:C1471("compareTo"; String:C10($1); "separator"; $2)).value)\
		)
