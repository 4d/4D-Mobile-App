...
If (This:C1470[""]=Null:C1517)  // Constructor
	...
	$o:=New object:C1471(\
		...
		"scroll"; Null:C1517; \
		"getScrollPosition"; Formula:C1597(_o_widget("getScrollPosition")); \
		"setScrollPosition"; Formula:C1597(_o_widget("setScrollPosition"; New object:C1471("vertical"; $1; "horizontal"; $2))); \
		"dimensions"; Null:C1517; \
		"getDimensions"; Formula:C1597(_o_picture("getDimensions")); \
		"getAttribute"; Formula:C1597(_o_picture("getAttribute"; New object:C1471("id"; $1; "attribute"; $2)))\
		)
