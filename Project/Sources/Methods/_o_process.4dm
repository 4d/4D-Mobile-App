...
If (This:C1470[""]=Null:C1517)  // Constructor
	...
	$o:=New object:C1471(\
		...
		"frontmost"; True:C214; \
		"update"; Formula:C1597(_o_process("update")); \
		"hide"; Formula:C1597(_o_process("hide")); \
		"show"; Formula:C1597(_o_process("show")); \
		"toFront"; Formula:C1597(_o_process("toFront")); \
	...
	Case of 
		...
		: ($1="update")
			...
			If ($o.isCooperatif)
				...
				$o.frontmost:=Formula from string:C1601("Frontmost process:C327=$1").call(Null:C1517; $o.number)
