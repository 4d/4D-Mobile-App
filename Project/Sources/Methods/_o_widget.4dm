...
If (This:C1470[""]=Null:C1517)  // Constructor
	...
	$o:=New object:C1471(\
		...
		"bestSize"; Formula:C1597(_o_widget("bestSize"; New object:C1471("alignment"; $1; "minWidth"; $2; "maxWidth"; $3))); \
		...
		"setTitle"; Formula:C1597(_o_widget("setTitle"; New object:C1471("title"; String:C10($1)))); \
		...
		"clear"; Formula:C1597(_o_widget("clear")); \
		...
		"distributeHorizontally"; Formula:C1597(_o_widget("distributeHorizontally"; $1)); \
		...
		"forceNumeric"; Formula:C1597(_o_widget("forceNumeric")); \
		...
		"setFilter"; Formula:C1597(_o_widget("setFilter"; New object:C1471(Choose:C955(Value type:C1509($1)=Is text:K8:3; "value"; "format"); $1; "separator"; $2))); \
		"setValue"; Formula:C1597(_o_widget("setValue"; New object:C1471("value"; $1))); \
		"touch"; Formula:C1597(_o_widget("touch")); \
		"value"; Formula:C1597(_o_widget("value").value)\
		)
