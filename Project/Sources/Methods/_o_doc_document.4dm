...
If (False:C215)
	C_OBJECT:C1216(_o_doc_document; $0)
	C_OBJECT:C1216(_o_doc_document; $1)
End if 
...
Case of 
	...
	: ($Obj_document.action="properties")
		...
		$Obj_document.isAlias:=(Length:C16(_o_doc_resolveAlias($Obj_document.path))>0)
	...
	: ($Obj_document.action="copy")
		...
		$Obj_document.success:=_o_doc_document($Obj_document).success
