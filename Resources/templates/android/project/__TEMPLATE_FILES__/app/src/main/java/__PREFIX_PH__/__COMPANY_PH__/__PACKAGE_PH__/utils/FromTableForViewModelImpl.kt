...
import {{prefix}}.{{company}}.{{app_name}}.data.model.entity.{{name}}ManyToOneRelationMask
{{/tableNames}}
{{#tableNames}}
import {{prefix}}.{{company}}.{{app_name}}.viewmodel.entity.EntityViewModel{{name}}
{{/tableNames}}
{{#tableNames}}
import {{prefix}}.{{company}}.{{app_name}}.viewmodel.entityList.EntityListViewModel{{name}}
{{/tableNames}}
