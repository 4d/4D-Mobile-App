...
import {{prefix}}.{{company}}.{{app_name}}.android.build.utils.DRIVER_CLASSNAME
import {{prefix}}.{{company}}.{{app_name}}.android.build.utils.SQL_DB_URL_PREFIX
import {{prefix}}.{{company}}.{{app_name}}.android.build.utils.closureOf
