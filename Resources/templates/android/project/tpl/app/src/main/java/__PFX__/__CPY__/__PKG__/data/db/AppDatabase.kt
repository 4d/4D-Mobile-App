...
package {{prefix}}.{{company}}.{{app_name}}.data.db
...
import {{prefix}}.{{company}}.{{app_name}}.data.converter.Converters
{{#tableNames}}
import {{prefix}}.{{company}}.{{app_name}}.data.dao.entity.{{name}}Dao
{{/tableNames}}
{{#relations}}
import {{prefix}}.{{company}}.{{app_name}}.data.dao.relation.{{relation_source}}Has{{relation_target}}RelationDao
{{/relations}}
{{#tableNames}}
